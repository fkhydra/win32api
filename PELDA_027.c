...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        egerkurzor = LoadCursor(NULL, IDC_PIN);
        SetCursor(egerkurzor);
        return 0;
        //*********************************
    ...
    case WM_SETCURSOR:
        ...
        {
            if (atvaltas) SetCursor(sajat_kurzor);
            else SetCursor(egerkurzor);
            return TRUE;
        }
        break;
    case WM_HSCROLL:
    ...
    case WM_COMMAND:
        ...
        case OBJ_ID100:
            if (!atvaltas)
            {
                ...
                sajat_kurzor = CreateCursor(hInstGlob,
                    2, 
                    2,
                    32,
                    32, 
            ...
            MessageBox(NULL, L"Kurzor megváltoztatva!", L"Felhasználói interakció", MB_OK | MB_ICONINFORMATION);
            break;
        }
