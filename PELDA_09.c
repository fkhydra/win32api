    ...
    case WM_HSCROLL:
        switch (LOWORD(wParam))
        {
            case SB_LINELEFT:
            {
                ...
                {
                case OBJ_ID100:
                    MessageBoxA(NULL, "Balra kattintás", "Felhasználói interakció", MB_OK | MB_ICONINFORMATION);
                    break;
                }
            }
            break;
            case SB_LINERIGHT:
            {
                ...
                {
                case OBJ_ID100:
                    MessageBoxA(NULL, "Jobbra kattintás", "Felhasználói interakció", MB_OK | MB_ICONINFORMATION);
                    break;
                }
            }
            break;
            ...
            case SB_PAGELEFT:
            {
                ...
                case OBJ_ID100:
                    ...
                    strcpy_s(uzenet, "Balra lapozás, új pozíció: ");
            ...
            case SB_PAGERIGHT:
            {
                ...
                case OBJ_ID100:
                    ...
                    strcpy_s(uzenet, "Jobbra lapozás, új pozíció: ");
                    s1 = SendMessage(HScrollBar1, SBM_GETPOS, 0, 0);
                    _itoa_s(s1+10,ertek,10);
                    strcat_s(uzenet, ertek);
                    SendMessage(HScrollBar1, SBM_SETPOS, s1+10, TRUE);
