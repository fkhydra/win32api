...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        Button1 = CreateWindow(TEXT("button"), TEXT("Szín kiválasztása")
    ...
    case WM_COMMAND:
        ...
        case OBJ_ID100:
            ...
            if (szin != FALSE); /*a felhasználó az 'OK' gombra kattintott, vagyis kiválasztott egy színt*/
            _itoa_s(ColorDialog1.rgbResult, ertek, 10);
            MessageBoxA(NULL, ertek, "Felhasználói interakció", MB_OK | MB_ICONINFORMATION);
            break;
        }
        return 0;
        //*********************************
