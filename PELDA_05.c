...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        {
        case OBJ_ID100:
            MessageBox(NULL, L"Kattintást érzékeltem!", L"Felhasználói interakció", MB_OK | MB_ICONINFORMATION);
            break;
        }
