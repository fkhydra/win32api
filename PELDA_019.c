...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        szelek[0] = 100;
        szelek[1] = 442;
        SendMessage(StatusBar1, SB_SETPARTS, 2, (LPARAM)&szelek);
        SendMessage(StatusBar1, SB_SETTEXT, 0, (LPARAM)TEXT("SZÖVEG1"));
        SendMessage(StatusBar1, SB_SETTEXT, 1, (LPARAM)TEXT("SZÖVEG2"));
        return 0;
        //*********************************
