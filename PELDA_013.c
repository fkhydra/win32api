...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_NOTIFY: {
        ...
        {
        case OBJ_ID100:
            if ((((LPNMUPDOWN)lParam)->iDelta) >= 0) MessageBox(NULL, L"Kattintást lefelé!", L"Felhasználói interakció", MB_OK | MB_ICONINFORMATION);
            if ((((LPNMUPDOWN)lParam)->iDelta) < 0) MessageBox(NULL, L"Kattintást felfelé!", L"Felhasználói interakció", MB_OK | MB_ICONINFORMATION);
            break;
        }
        return 0;
    }
