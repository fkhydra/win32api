...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 1");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 2");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 3");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 4");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 5");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 6");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 7");
        SendMessage(ComboBox1, CB_ADDSTRING, 0, (LPARAM)L"Listaelem 8");
        return 0;
        //*********************************
    ...
    case WM_COMMAND:
        ...
        if (LOWORD(wParam) == OBJ_ID100 && HIWORD(wParam) == LBN_SELCHANGE)
        {
            ...
            sorszam = (int)SendMessage(ComboBox1, CB_GETCURSEL, (WPARAM)0, (LPARAM)0);
            hossz = (int)SendMessage(ComboBox1, CB_GETLBTEXTLEN, (WPARAM)sorszam, 0);
            SendMessageA(ComboBox1, CB_GETLBTEXT, (WPARAM)sorszam, (LPARAM)elem_neve);
