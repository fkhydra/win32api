...
TCHAR teljesutvonal[MAX_PATH], fajlnev[MAX_PATH];
...
LRESULT CALLBACK WndProc0(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case OBJ_ID100:
            ...
            {
                ShowMessage((LPCWSTR)teljesutvonal, TEXT("Elérési út:"), Form1);
            }
            break;
        }
        return 0;
